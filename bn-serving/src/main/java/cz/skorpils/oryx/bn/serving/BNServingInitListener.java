...
/**
 * <p>This servlet lifecycle listener makes sure that the shared {@link } instance
 * is initialized at startup, along with related objects, and shut down when the container is destroyed.</p>
 *
 * @author Sean Owen
 */
public final class BNServingInitListener extends AbstractOryxServingInitListener {

  private static final Logger log = LoggerFactory.getLogger(BNServingInitListener.class);
