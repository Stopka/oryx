...
public interface OryxRecommender {
   ...
   * @throws NoSuchUserException if the user is not known
   */
  List<Long> recommend(String userID, int howMany, Rescorer rescorer)
   ...
   */
  List<Long> mostSimilarItems(String itemID, int howMany)
      throws NoSuchItemException, NotReadyException;

  /**
   * @param itemID ID of item for which to find most similar other items
   * @param howMany desired number of most similar items to find
   * @param rescorer PairRescorer which can adjust item-item similarity estimates used to determine
   ...
   * @throws NoSuchItemException if the item is not known
   */
  List<Long> mostSimilarItems(String itemID, int howMany, PairRescorer rescorer)
      throws NoSuchItemException, NotReadyException;
   ...
   */
  List<Long> mostSimilarItems(String[] itemIDs, int howMany)
      throws NoSuchItemException, NotReadyException;
   ...
   *  exist in the model. Otherwise, unknown items are ignored.
   */
  List<Long> mostSimilarItems(String[] itemIDs,
                                 int howMany,
   ...
   *
   * <p>This returns a {@link java.util.List} of Long.
   ...
   * @return {@link java.util.List} of Long, ordered from most influential in recommended the
   *  given item to least
   */
  List<Long> recommendedBecause(String userID, String itemID, int howMany)
   ...
   * @return {@link java.util.List} of recommended Longs, ordered from most strongly recommend to least
   * @throws NotReadyException if the recommender has no model available yet
   */
  List<Long> recommend(String userID,
                          int howMany,
   ...
   */
  List<Long> recommendToMany(String[] userIDs,
                                int howMany,
                                boolean considerKnownItems,
                                Rescorer rescorer) throws NoSuchUserException, NotReadyException;
   ...
   *  exist in the model. Otherwise, unknown items are ignored.
   */
  List<Long> recommendToAnonymous(String[] itemIDs, int howMany)
   ...
   */
  List<Long> recommendToAnonymous(String[] itemIDs, float[] values, int howMany)
      throws NotReadyException, NoSuchItemException;
   ...
   *  exist in the model. Otherwise, unknown items are ignored.
   */
  List<Long> recommendToAnonymous(String[] itemIDs, int howMany, Rescorer rescorer)
      throws NotReadyException, NoSuchItemException;
   ...
   *  exist in the model. Otherwise, unknown items are ignored.
   */
  List<Long> recommendToAnonymous(String[] itemIDs,
                                     float[] values,
                                     int howMany,
                                     Rescorer rescorer)
      throws NotReadyException, NoSuchItemException;
   ...
   */
  List<Long> mostPopularItems(int howMany) throws NotReadyException;

  List<Long> mostPopularItems(int howMany, Rescorer rescorer) throws NotReadyException;
  ...
  /**
   * Like {@link #ingest(java.io.File)}, but reads from a {@link java.io.Reader}.
   *
